...
urlpatterns = [
    ...
    path("alert-config/slack/save/", views.save_slack_config, name="save_slack_config"),
    path("alert-config/slack/clear/", views.clear_slack_config, name="clear_slack_config"),
    path("alert-config/slack/test/", views.test_slack_config, name="test_slack_config"),
    ...
    path("api/alerts/bulk-delete/", views.bulk_delete_alerts, name="bulk_delete_alerts"),
    ...
    path("api/anomalies/notifications/", views.anomaly_notifications_api, name="anomaly_notifications_api"),
    path("api/anomalies/clear-all/", views.anomaly_clear_all_api, name="anomaly_clear_all_api"),
    path("api/dashboard/summary-stats/", views.dashboard_summary_stats_api, name="dashboard_summary_stats_api"),
    path("api/dashboard/cpu-trend/<str:period>/", views.dashboard_cpu_trend_api, name="dashboard_cpu_trend_api"),
    path("api/dashboard/memory-trend/<str:period>/", views.dashboard_memory_trend_api, name="dashboard_memory_trend_api"),
    path("api/dashboard/network-trend/<str:period>/", views.dashboard_network_trend_api, name="dashboard_network_trend_api"),
    ...
    path("api/dashboard/response-time-trend/<str:period>/", views.dashboard_response_time_trend_api, name="dashboard_response_time_trend_api"),
    path("api/dashboard/monitored-services/", views.dashboard_monitored_services_api, name="dashboard_monitored_services_api"),
    path("api/dashboard/trend-insights/", views.dashboard_trend_insights_api, name="dashboard_trend_insights_api"),
    path("api/dashboard/reliability-metrics/", views.dashboard_reliability_metrics_api, name="dashboard_reliability_metrics_api"),
